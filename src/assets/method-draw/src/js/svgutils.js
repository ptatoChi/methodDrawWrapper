...
// Ensure browser.js is loaded before continuing
if (!svgedit.browser) {
  console.warn('browser.js not loaded, creating fallback browser object');
  svgedit.browser = {
    supportsSelectors: function() { return !!document.querySelector; },
    supportsXpath: function() { return !!document.evaluate; }
  };
}
...
if (svgedit.browser && svgedit.browser.supportsSelectors && svgedit.browser.supportsSelectors()) {
  svgedit.utilities.getElem = function(id) {
    // querySelector lookup
    return svgroot_.querySelector('#'+id);
  };
} else if (svgedit.browser && svgedit.browser.supportsXpath && svgedit.browser.supportsXpath()) {
  svgedit.utilities.getElem = function(id) {
    // xpath lookup
