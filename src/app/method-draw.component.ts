...
@Component({
    ...
    template: `<button (click)="importSvg('')">Import SVG</button>
    <br><br><div #container class="editor-host"></div>`,
})
export class MethodDrawComponent implements AfterViewInit {
    ...
    async ngAfterViewInit() {
        const editor = await createMethodDrawEditor(this.containerRef.nativeElement, {
            // toolset: ['select', 'rect', 'ellipse'],          // only keep these
            extendContextMenu(menu: any) {
                const li = document.createElement('li');
                li.innerHTML = '<a href="#hello">Say Hello</a>';
                li.addEventListener('click', () => alert('Hello from Angular!'));
                menu.appendChild(li);
            }
        });
        console.log(editor);
